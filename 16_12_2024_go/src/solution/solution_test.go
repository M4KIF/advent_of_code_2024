...
func TestPart1WithChallengeData(t *testing.T) {
	...
	// Altering the data to suit the test
	assert.Equal(t, testSolution.Part1(), 98416)
}

func TestPart2With15By15DataFromExample(t *testing.T) {
	path := "./test_data/data_2.txt"
	...
	// Altering the data to suit the test
	assert.Equal(t, testSolution.Part2(), 45)
}

func TestPart2With16By16DataFromExample2(t *testing.T) {
	path := "./test_data/data_3.txt"
	...
	// Altering the data to suit the test
	assert.Equal(t, testSolution.Part2(), 64)
}

func TestPart2WithChallengeData(t *testing.T) {
	path := "./test_data/data_4.txt"
	...
	// Altering the data to suit the test
	assert.Equal(t, testSolution.Part2(), 471)
}
